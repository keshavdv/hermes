...
/* Generated by nanopb-0.3.3 at Fri Apr  8 21:39:46 2016. */
...
const pb_field_t Payload_fields[6] = {
    ...
    PB_FIELD(  5, MESSAGE , OPTIONAL, STATIC  , OTHER, Payload, update, response, &SensorState_fields),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Payload, profile) < 65536 && pb_membersize(Payload, request) < 65536 && pb_membersize(Payload, response) < 65536 && pb_membersize(Payload, update) < 65536 && pb_membersize(DeviceProfile, sensors) < 65536 && pb_membersize(DeviceConfiguration, configuration) < 65536 && pb_membersize(DeviceControlRequest, config) < 65536 && pb_membersize(DeviceControlResponse, config) < 65536 && pb_membersize(SensorState, messages) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_Payload_Sensor_DeviceProfile_SensorConfiguration_DeviceConfiguration_DeviceControlRequest_DeviceControlResponse_SensorValue_SensorState)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(Payload, profile) < 256 && pb_membersize(Payload, request) < 256 && pb_membersize(Payload, response) < 256 && pb_membersize(Payload, update) < 256 && pb_membersize(DeviceProfile, sensors) < 256 && pb_membersize(DeviceConfiguration, configuration) < 256 && pb_membersize(DeviceControlRequest, config) < 256 && pb_membersize(DeviceControlResponse, config) < 256 && pb_membersize(SensorState, messages) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_Payload_Sensor_DeviceProfile_SensorConfiguration_DeviceConfiguration_DeviceControlRequest_DeviceControlResponse_SensorValue_SensorState)
#endif
