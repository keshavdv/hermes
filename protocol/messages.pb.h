...
typedef enum _Payload_MsgType {
    Payload_MsgType_DeviceProfile = 0,
...
#define Sensor_init_default                      {0, (Sensor_SensorType)0, ""}
#define DeviceProfile_init_default               {"", {{NULL}, NULL}}
...
#define Sensor_init_zero                         {0, (Sensor_SensorType)0, ""}
#define DeviceProfile_init_zero                  {"", {{NULL}, NULL}}
